...
register_telegram(commands.dog_breedlist, ["dog", "doggo", "cane", "woof", "bau"], "(?:list|help|aiuto)")
register_telegram(commands.dog_breed, ["dog", "doggo", "cane", "woof", "bau"], "(?P<breed>[A-Za-z/]+)")
register_telegram(commands.fortune, ["fortune"])
register_telegram(commands.pmots, ["pmots"])
register_telegram(commands.spell, ["spell", "cast"], "(?P<spellname>.+)")
...
register_telegram(commands.balance, ["balance", "fiorygi"])
